              ...
              <div class="col-12">
                <div class="card">
                  ...
                  >
                    <div
                      v-if="
                        $userPermissions.includes('permissions-read') == true
                      "
                    >
                      <vue-good-table
                        :columns="columns"
...
export default {
  ...
  mounted() {
    this.currentPage = Number(localStorage.getItem("currentPagePermission"));
  ...
  methods: {
    onPageChange(params) {
      localStorage.setItem("currentPagePermission", params.currentPage);
      this.currentPage = Number(localStorage.getItem("currentPagePermission"));
    },
    delete_record: function (id) {
      this.$swal({
        ...
        if (isConfirm === true) {
          axios.delete(route("permissions.destroy", id)).then(
            (response) => {
