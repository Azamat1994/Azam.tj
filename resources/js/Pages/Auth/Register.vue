                        ...
                        <div>
                            ...
                            <div class="form-floating mb-3">
                                <input v-model="register.password" @keyup="validate" required type="password"
                                       class="form-control feedback-input" id="password" name="password" placeholder="Введите пароль">
                            ...
                            <a :href="route('auth.reset-password')" class="text-dark">Сбросить пароль</a>
                        </div>
                    </div>
                </div>
                <div class="row">
