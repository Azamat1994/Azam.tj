          ...
          <div class="header-body">
            <div class="row align-items-end">
              <div class="col">
                ...
                <h1 class="header-title">Слайдеры</h1>
              </div>
            </div>
          </div>
        </div>
                ...
                <div class="card">
                  <div class="card-header">
                    <div class="row align-items-center">
                      ...
                      <div
                        v-if="
                          $userPermissions.includes('sliders-create') == true
                        "
                        class="col-auto"
                      >
                        <a
                  ...
                  >
                    <div
                      v-if="$userPermissions.includes('sliders-read') == true"
                    >
                      <vue-good-table
                        :columns="columns"
                        :rows="rows"
                      ...
                      >
                        ...
                        <template slot="table-row" slot-scope="props">
                          <span v-if="props.column.field == 'actions'">
                            <a
                              v-if="
                                $userPermissions.includes('sliders-update') ==
                                true
                              "
                              :href="
                                '/dashboard/sliders/' + props.row.id + '/edit'
                              "
                              title="Редактировать"
                            ...
                            <button
                              v-if="
                                $userPermissions.includes('sliders-delete') ==
                                true
                              "
                              title="Удалить"
...
export default {
  ...
  mounted() {
    this.currentPage = Number(localStorage.getItem("currentPageSlider"));
  ...
  methods: {
    onPageChange(params) {
      localStorage.setItem("currentPageSlider", params.currentPage);
      this.currentPage = Number(localStorage.getItem("currentPageSlider"));
    },
    delete_record: function (id) {
      this.$swal({
        ...
        if (isConfirm === true) {
          axios.delete(route("sliders.destroy", id)).then(
            (response) => {
