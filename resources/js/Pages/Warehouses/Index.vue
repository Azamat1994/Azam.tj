                ...
                <div class="card">
                  <div class="card-header">
                    <div class="row align-items-center">
                      <div class="col">
                        <h4 class="card-header-title">Склады</h4>
                      </div>
                      <div
                        v-if="
                          $userPermissions.includes('warehouses-create') == true
                        "
                        class="col-auto"
                      >
                        <a
                  ...
                  >
                    <div
                      v-if="
                        $userPermissions.includes('warehouses-read') == true
                      "
                    >
                      <vue-good-table
                        :columns="columns"
...
export default {
  ...
  methods: {
    onPageChange(params) {
      localStorage.setItem("currentPageWareHouse", params.currentPage);
      this.currentPage = Number(localStorage.getItem("currentPageWareHouse"));
    },
    delete_record: function (id) {
      this.$swal({
        title: "Вы уверены?",
        text: "Склад будет удален безвозвратно!",
        type: "warning",
        buttons: {
          confirm: {
            text: "Да",
        ...
        if (isConfirm === true) {
          axios.delete(route("warehouses.destroy", id)).then(
            (response) => {
