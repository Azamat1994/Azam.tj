                ...
                <div class="card">
                  <div class="card-header">
                    <div class="row align-items-center">
                      <div class="col">
                        <h4 class="card-header-title">Категории</h4>
                      </div>
                      <div
                        v-if="
                          $userPermissions.includes('categories-create') == true
                        "
                        class="col-auto"
                      >
                        <a
                  ...
                  >
                    <div
                      v-if="
                        $userPermissions.includes('categories-read') == true
                      "
                    >
                      <vue-good-table
                        :columns="columns"
...
export default {
  ...
  methods: {
    onPageChange(params) {
      localStorage.setItem("currentPageCategory", params.currentPage);
      this.currentPage = Number(localStorage.getItem("currentPageCategory"));
    },
    delete_record: function (id) {
      this.$swal({
        title: "Вы уверены?",
        text: "Категория, а также все продукты этой категории будут удалены безвозвратно!",
        type: "warning",
        buttons: {
          confirm: {
            text: "Да",
        ...
        if (isConfirm === true) {
          axios.delete(route("categories.destroy", id)).then(
            (response) => {
